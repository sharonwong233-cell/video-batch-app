...
VIAddVersionKey /LANG=2052 "ProductName" "FrameFlow 安装程序"
VIAddVersionKey /LANG=2052 "CompanyName" "SharonWong"
VIAddVersionKey /LANG=2052 "FileDescription" "FrameFlow 安装向导"
...
Section "FrameFlow 主程序及视频引擎（必选）" Main
 ...
 WriteRegStr HKCU "${REG_UNINSTALL}" "DisplayName" "FrameFlow"
